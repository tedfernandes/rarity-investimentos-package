    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-[85vh] sm:min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroBg} alt="" className="w-full h-full object-cover object-[center_30%] sm:object-[center_15%]" />
        ...
        <div className="relative z-10 container mx-auto px-3 sm:px-6 lg:px-8 mt-[-20px] sm:mt-[-70px]">
          <div className="max-w-2xl fade-in text-center sm:text-left mx-auto sm:mx-0">
            <img src={logoRarity} alt="Rarity Chalés" className="w-[98px] sm:w-[124px] mb-[35px] sm:mb-[20px] mx-auto sm:mx-0 invert sm:ml-[10px]" />
